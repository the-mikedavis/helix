...
use helix_core::{
    ...
    syntax, ChangeSet, Diagnostic, Language, LineEnding, Range, Rope, RopeBuilder, Selection,
    Syntax, Transaction,
};
...
impl Document {
    ...
    ) -> Option<Arc<helix_core::syntax::config::LanguageConfiguration>> {
        let language = loader
    ...
    pub fn language(&self) -> Option<Language> {
        self.syntax().map(Syntax::root_language)
    }
